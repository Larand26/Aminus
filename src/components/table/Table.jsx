          ...
          <tbody>
            {loading ? (
              ...
              filteredDatas.map((data, rowIndex) => (
                <tr
                  key={rowIndex}
                  className={`${rowIndex % 2 === 0 ? "even-row" : "odd-row"} ${hover ? "hover-row" : ""} ${this.props.rowSelected?.value === data[this.props.rowSelected?.key] && this.props.rowSelected?.value ? "row-selected" : ""}`}
